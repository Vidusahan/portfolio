  ...
  return (
    ...
    >
      <div className="mb-4 font-mono text-xs tracking-[0.3em] text-text-dim uppercase">
        Phase 07 <b className="text-cyan font-medium">·</b> Certifications &amp; Blog
      </div>
      <h2 className="mx-auto mb-[34px] max-w-[640px] font-display text-[clamp(1.4rem,3vw,2.1rem)] leading-[1.4] font-medium text-text-dim">
        Everything through the blog is live.{' '}
        <b className="font-semibold text-text">The AI portfolio assistant and Contact</b>{' '}
        are being built next in the same visual language.
      </h2>
